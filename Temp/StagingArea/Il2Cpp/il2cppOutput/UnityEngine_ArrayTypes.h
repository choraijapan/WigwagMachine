...
// UnityEngine.AndroidJavaClass[]
struct AndroidJavaClassU5BU5D_t1407509546  : public Il2CppArray
{
public:
	ALIGN_FIELD (8) AndroidJavaClass_t1816259147 * m_Items[1];

public:
	inline AndroidJavaClass_t1816259147 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline AndroidJavaClass_t1816259147 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, AndroidJavaClass_t1816259147 * value)
	{
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
	}
